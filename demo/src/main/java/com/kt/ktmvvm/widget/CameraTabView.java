...
public class CameraTabView extends HorizontalScrollView {
    ...
    private void removeTabViewAt(int position) {
        try {
            if (mSlidingTabIndicator != null && mSlidingTabIndicator.getChildCount() > position) {
                final TabView view = (TabView) mSlidingTabIndicator.getChildAt(position);

                ViewParent parent = view.getParent();
                if (parent != null && parent instanceof SlidingTabIndicator) {
                    SlidingTabIndicator slidingTabIndicator = (SlidingTabIndicator) parent;
                    slidingTabIndicator.removeView(view);
                }
